...
/* definitions for field: Number of phase measurement averages in reg: Phase Measurement Control register */
#define TIM_RCV_CORE_PHASE_MEAS_CTL1_NAVG_MASK WBGEN2_GEN_MASK(0, 32)
#define TIM_RCV_CORE_PHASE_MEAS_CTL1_NAVG_SHIFT 0
#define TIM_RCV_CORE_PHASE_MEAS_CTL1_NAVG_W(value) WBGEN2_GEN_WRITE(value, 0, 32)
#define TIM_RCV_CORE_PHASE_MEAS_CTL1_NAVG_R(reg) WBGEN2_GEN_READ(reg, 0, 32)
...
/* definitions for field: Phase Difference in reg: Averaged Phase Difference Measurement */
#define TIM_RCV_CORE_PHASE_MEAS_VAL_MASK      WBGEN2_GEN_MASK(0, 32)
#define TIM_RCV_CORE_PHASE_MEAS_VAL_SHIFT     0
#define TIM_RCV_CORE_PHASE_MEAS_VAL_W(value)  WBGEN2_GEN_WRITE(value, 0, 32)
#define TIM_RCV_CORE_PHASE_MEAS_VAL_R(reg)    WBGEN2_GEN_READ(reg, 0, 32)
...
#define TIM_RCV_CORE_REG_PHASE_MEAS_CTL1 0x00000000
