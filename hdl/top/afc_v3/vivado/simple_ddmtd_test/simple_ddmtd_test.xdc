...
## BOOT_CLK_IN. This cannot be used with DDR3 core as there are
...
#Simply providing correct connections will generate errors "Cannot set LOC ... because the PACKAGE_PIN is occupied by ..."
...
# DDR3 reset path. Copied from ddr_core.xdc and modified accordingly
...
# is activated many many miliseconds after all of the other. So, give it 1x the destination clock
# period
